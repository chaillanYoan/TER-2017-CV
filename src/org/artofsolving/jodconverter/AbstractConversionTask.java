...
public abstract class AbstractConversionTask implements OfficeTask {
    ...
    public AbstractConversionTask(File inputFile, File outputFile) {
        ...
        System.out.println("AbstractConversionTask line 59 - this.inputFile.getAbsolutePath()"+this.inputFile.getAbsolutePath());
    ...
    protected XComponent loadDocument(OfficeContext context, File inputFile)
    	...
    	System.out.println("AbstractConversionTask.java:95 - inputFile.getAbsolutePath():"+inputFile.getAbsolutePath());
