    ...
    public static void main(String[] arguments) throws ParseException, JSONException, IOException {
        ...
        try {
            if (outputFormat == null) {
                ...
                System.out.println("input is abolsute:"+inputFile.isAbsolute()+" "+inputFile.exists());
                System.out.println("ouput is abolsute:"+outputFile.isAbsolute()+" "+outputFile.exists());
                
                
                System.out.println("Converter line 106 - inputFile.getAbsolutePath()"+inputFile.getAbsolutePath());
